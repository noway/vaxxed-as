...
const verifyPassURIWithTrustedIssuers = async (
  uri: string,
...
const verifyPassURI = async (uri: string): Promise<VerificationResult> =>
  verifyPassURIWithTrustedIssuers(uri, nzcpTrustedIssuers);
